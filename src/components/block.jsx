    ...
    return (
      <Fragment key={date}>
        ...
        {!!events.length && window.location.search.includes(config.pass) && (
          <div className="bg-yellow-500/20 rounded-lg flex flex-col p-3 gap-3">
            <div className="text-lg font-bold text-yellow-300 flex items-center gap-2">
              ...
              You have events scheduled this day!
            </div>
            <div className="flex flex-col gap-1 text-yellow-50">
              {events.map((e) => (
                <div className="flex justify-between gap-3">
                  <div className="flex-1 font-semibold whitespace-nowrap">
                    {e.private ? (
                  ...
                  <div className="text-right">{e.blocks.join(", ")}</div>
                </div>
              ))}
            </div>
          </div>
